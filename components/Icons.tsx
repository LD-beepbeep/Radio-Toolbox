...
export const BroadcastIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 12v-2"></path><path d="M16 16.22A9 9 0 1 0 7.8 16.27"></path><path d="M12 18v-6"></path><path d="m15 11-1 1-1-1"></path><path d="m11 11 1-1 1 1"></path><path d="M12 12a3 3 0 0 1 3 3h-6a3 3 0 0 1 3-3z"></path>
    </svg>
);
...
export const NormalizeCompressIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <polyline points="20 16 20 22 14 22"></polyline>
      <polyline points="4 8 4 2 10 2"></polyline>
      <line x1="14" y1="10" x2="20" y2="2"></line>
      <line x1="4" y1="22" x2="10" y2="14"></line>
      <path d="M7 10.2c.5-.6.5-1.5 0-2.1l-1-1.2c-.5-.6-.5-1.5 0-2.1l1-.9c.5-.6 1.3-.6 1.8 0l1 1c.5.6.5 1.5 0 2.1l-1 1.2c-.5.6-.5 1.5 0 2.1l1 .9c.5.6 1.3.6 1.8 0l1-1c.5-.6.5-1.5 0-2.1"></path>
    </svg>
);
...
export const WaveformVisualizerIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M7 12h2l2-4 2 4h2"></path>
        <path d="m15 12-2 4-2-4"></path>
    </svg>
);

export const ShowPosterMakerIcon = (props: IconProps) => (
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21.25 2H2.75A2.75 2.75 0 0 0 0 4.75v14.5A2.75 2.75 0 0 0 2.75 22h18.5A2.75 2.75 0 0 0 24 19.25V4.75A2.75 2.75 0 0 0 21.25 2zM8 12l-2 4h12l-4-8-4 4z"></path>
    </svg>
);